<?php $__env->startSection('content'); ?>
                    ...
                    <section class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="<?php echo e(route('students.roll.store')); ?>" id="myForm">
                                    <?php echo csrf_field(); ?>
                                    <div class="form-row">
    ...
    <script type="text/javascript">
        $(document).on('click','#search',function () {
            ...
            $.ajax({
            url:"<?php echo e(route('students.roll.get-student')); ?>",
                type:"GET",
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\schoolmng\resources\views/backend/student/student_roll/view-roll-generate.blade.php ENDPATH**/ ?>