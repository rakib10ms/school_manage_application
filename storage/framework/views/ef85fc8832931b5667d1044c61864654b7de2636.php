  ...
  <body>
    <div class="page login-page">
      <div class="container" style="max-width: 100%;">
          <div class="row">
          <div class="col-md-7" style="background-size: cover;background-image:url('<?php echo e(URL::to('/public/logo/ashikkha-login.png')); ?>'); ">
              
          </div>
          <div class="col-md-5">
            <div class="form-outer text-center d-flex align-items-center bg-light">
          <div class="form-inner  " style="background-color:#12232E;box-shadow: 1px 1px 5px rgba(0,0,0,0.3">
            <div class="logo" style="padding: 1rem; border-radius: 7px;"><img src="<?php echo e(URL::to('/public/logo/atech-shikkha-logo.png')); ?>" width="150" >
            <br><span style="font-size: 23px; font-weight: bold"><?php echo e($general_setting->site_title); ?></span></div>
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" id="login-form">
              ...
              <div class="form-group-material">
                <input id="login-username" type="text" name="name" required class="input-material" value="" style="padding: 0.6rem;">
              ...
              <div class="form-group-material">
                <input id="login-password" type="password" name="password" required class="input-material" value="" style="padding: 0.6rem;">
              ...
              <button type="submit" class="btn btn-danger btn-block"><?php echo e(trans('file.LogIn')); ?></button>
            </form>
...
</script><?php /**PATH C:\laragon\www\schoolmng\resources\views/auth/login.blade.php ENDPATH**/ ?>