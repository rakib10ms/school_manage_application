...
*/      z-index: 999;
  ...
  <body onload="myFunction()">
    <div id="loader"></div>
      <!-- Side Navbar -->
      <nav class="side-navbar" style="background-color: #12232E;">
        ...
        <li><a href="<?php echo e(url('/')); ?>"> <i class="dripicons-meter"></i><span><?php echo e(__('file.dashboard')); ?></span></a></li>
               <?php
                 ...
                 //$role = DB::table('roles')->where('id',$user_id)->get();
              ...
              <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-user-circle-o"></i><span>Users</span><span></a>
                <ul id="product" class="collapse list-unstyled ">
                  <li id="category-menu"><a href="<?php echo e(route('viewUsers')); ?>">All Users</a></li>
                  <li id="category-menu"><a href="<?php echo e(route('viewParent')); ?>">All Parents</a></li>
              ...
              <li><a href="#purchase" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-university"></i><span>Academic</span></a>
                <ul id="purchase" class="collapse list-unstyled ">
                  ...
                  <li id=""><a href="<?php echo e(route('students.registration.view')); ?>">Student Registration</a></li>
                  
                  <li id=""><a href="<?php echo e(route('setups.student.class.view')); ?>">Student Class</a></li>
                  <li id=""><a href="<?php echo e(route('setups.student.year.view')); ?>">View Year</a></li>
                  <li id=""><a href="<?php echo e(route('setups.student.group.view')); ?>">View Group</a></li>
                  <li id=""><a href="<?php echo e(route('setups.student.shift.view')); ?>">Student Shift</a></li>
                  
                  <li id=""><a href="<?php echo e(route('setups.subject.view')); ?>">Subject View</a></li>
                  <li id=""><a href="<?php echo e(route('setups.assign.subject.view')); ?>">Assign Subject</a></li>
                  <li id=""><a href="<?php echo e(route('setups.designation.view')); ?>">Designation</a></li>
                  <li id=""><a href="<?php echo e(route('students.roll.view')); ?>">Roll Generate</a></li>
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-graduation-cap"></i><span>Exam</span></a>
                <ul id="sale" class="collapse list-unstyled ">
                  <?php if($sale_index_permission_active): ?>
                  <li id=""><a href="<?php echo e(route('setups.exam.type.view')); ?>">Exam Type</a></li>
                  <li id=""><a href="<?php echo e(route('marks.add')); ?>">Marks Entry</a></li>
                  <li id=""><a href="<?php echo e(route('marks.edit')); ?>">Marks Edit</a></li>
                  <li id=""><a href="<?php echo e(route('marks.grade.view')); ?>">Grade Point</a></li>
              ...
              <?php if($index_permission_active): ?>
              <li><a href="#expense" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-line-chart"></i><span>Accounting</span></a>
                <ul id="expense" class="collapse list-unstyled ">
                  <li id=""><a href="<?php echo e(route('setups.fee.category.view')); ?>">Fee Category</a></li>
                  <li id=""><a href="<?php echo e(route('setups.fee.amount.view')); ?>">Fee Category Amount</a></li>
                  <li id=""><a href="<?php echo e(route('accounts.fee.view')); ?>">Student Fee</a></li>
                  <!-- <li id="exp-list-menu"><a href="">Employee Salary</a></li> -->
                  
                  <li id=""><a href="<?php echo e(route('students.exam.fee.view')); ?>">Exam Fee</a></li>
                  
                  <li id=""><a href="<?php echo e(route('students.monthly.fee.view')); ?>">Monthly Fee</a></li>
                  <li id="quotation-list-menu"><a href="">Registration Fee</a></li>
                  <li id="quotation-list-menu"><a href="">Employee Salary</a></li>
                  <li id="quotation-list-menu"><a href="">Employee Monthly Salary</a></li>
                  <li id="exp-list-menu"><a href="<?php echo e(route('othercosts.index')); ?>">Account Other Cost</a></li>
                  ...
                  ?>
                  <?php if($add_permission_active): ?>
                  <li><a id="add-expense" href=""> Other Cost</a></li>
                  <?php endif; ?>
                </ul>
              </li>
              <?php endif; ?>
              ...
              ?>
              <?php if($index_permission_active): ?>
              <li><a href="#quotation" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document"></i><span>Back Office</span><span></a>
                <ul id="quotation" class="collapse list-unstyled ">
                  <li id="quotation-list-menu"><a href="">Employee Registration</a></li>
                  
                  <li id="quotation-list-menu"><a href="">Employee Leave</a></li>
                  <li id="quotation-list-menu"><a href="">Employee Attendance</a></li>
                  <li id="quotation-list-menu"><a href="<?php echo e(route('holiday.index')); ?>">Holidays</a></li>
                  <li id="quotation-list-menu"><a href="<?php echo e(route('contact')); ?>">Contact</a></li>
                  <li id="quotation-list-menu"><a href="<?php echo e(route('leave.index')); ?>">Leave Purpose</a></li>
              ...
              ?>
              <?php if($index_permission_active): ?>
              <li><a href="#transfer" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-cog"></i><span>Settings</span></a>
                <ul id="transfer" class="collapse list-unstyled ">
                  <li> 
                        <a href="<?php echo e(route('setting.general')); ?>">General Settings</a>
                  </li>
                  <li id="transfer-list-menu"><a href="<?php echo e(route('role.index')); ?>">Role Permission</a></li>
...
?>
        ...
        <?php if($department_active): ?>
              <li><a href="#hrm" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document"></i><span>HRM</span><span></a>
                <ul id="hrm" class="collapse list-unstyled ">
                  
                  <li id="quotation-list-menu"><a href="<?php echo e(route('departments.index')); ?>">Department</a></li>
                  <li id="quotation-list-menu"><a href="<?php echo e(route('employees.index')); ?>">Employee </a></li>
                  <li id="quotation-list-menu"><a href="<?php echo e(route('attendance.index')); ?>">Attendance</a></li>
                  <li id="quotation-list-menu"><a href="<?php echo e(route('holiday.index')); ?>">Holiday</a></li>
...
<!-- 
 ...
 -->
      ...
      <!-- navbar-->
      <header class="header " style="padding-bottom: 4rem;">
            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <?php if(\Auth::user()->role_id <= 2): ?>
                  <li hidden="" class="nav-item"><a href="<?php echo e(route('cashRegister.index')); ?>" title="<?php echo e(trans('file.Cash Register List')); ?>"><i class="dripicons-archive"></i></a></li>
                <?php endif; ?>
...
</html><?php /**PATH C:\laragon\www\schoolmng\resources\views/layout/main.blade.php ENDPATH**/ ?>