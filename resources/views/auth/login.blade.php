  ...
  <body>
    <div class="page login-page">
      <div class="container" style="max-width: 100%;">
          <div class="row">
          <div class="col-md-7" style="background-size: cover;background-image:url('{{ URL::to('/public/logo/ashikkha-login.png') }}'); ">
          ...
          <div class="form-inner  " style="background-color:#12232E;box-shadow: 1px 1px 5px rgba(0,0,0,0.3">
            <div class="logo" style="padding: 1rem; border-radius: 7px;"><img src="{{ URL::to('/public/logo/atech-shikkha-logo.png') }}" width="150" >
            <br><span style="font-size: 23px; font-weight: bold">{{$general_setting->site_title}}</span></div>
            ...
            <form method="POST" action="{{ route('login') }}" id="login-form">
              ...
              <button type="submit" class="btn btn-danger btn-block">{{trans('file.LogIn')}}</button>
            </form>
