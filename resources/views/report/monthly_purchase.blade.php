		...
		<div class="card"> 
			<div class="card-body"> 
				...
				<div class="table-responsive mt-4">
					<a type="button" class="btn btn-primary" href="{{ route('monthly-purchase-pdf', ['year' => $year]) }}">PDF</a>

					<a type="button" class="btn btn-primary" href="{{ route('monthly-purchase-print', ['year' => $year]) }}">Print</a>
