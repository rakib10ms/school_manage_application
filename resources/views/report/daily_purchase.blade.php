		...
		<div class="card"> 
			<div class="card-body"> 
				...
				<div class="input-group-append">
                	<a type="button" class="btn btn-primary" href="{{ route('daily-purchase-pdf', ['year' => $year, 'month' => $month]) }}">PDF</a>

                	<a type="button" class="btn btn-primary" href="{{ route('daily-purchase-print', ['year' => $year, 'month' => $month]) }}">Print</a>
            	</div>
