        ...
        <div class="container-fluid ">
          <div class="col-md-12 ">
           <!--  <div class="brand-text float-left ">
                <h3 class="" style="display: inline-block;padding: 1rem 2rem;border-radius:5px;background-color:black; color: white">{{trans('file.welcome')}} <span class="text-danger">{{Auth::user()->name}}</span></h3>
            </div>
                ...
                <div class="row">
                      <div class="col-md-6 cards">
                        <div class="card-counter primary">
                          ...
                          <span class="count-numbers">{{number_format((float)$revenue, 2, '.', '')}}</span>
                      ...
                      <div class="col-md-6 cards">
                        <div class="card-counter danger">
                          ...
                          <span class="count-numbers">{{number_format((float)$return, 2, '.', '')}}</span>
                    ...
                    <div class="row">
                      <div class="col-md-6 cards">
                        <div class="card-counter success">
                          ...
                          <span class="count-numbers">{{number_format((float)$purchase_return, 2, '.', '')}}</span>
                      ...
                      <div class="col-md-6 cards">
                        <div class="card-counter info">
                          ...
                          <span class="count-numbers">{{number_format((float)$profit, 2, '.', '')}}</span>
