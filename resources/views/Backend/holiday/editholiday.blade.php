...
<div class="p-5">
                            ...
                            <form class="user" action="{{route('holiday.update',$editHoliday->id)}}" method="POST">
                            	@csrf
                                <div class="form-group row">
                                    <div class="col-sm-12 my-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName" placeholder="Holiday Tittle" name="tittle" value="{{$editHoliday->tittle}}">
                                    </div>
