        ...
        <li><a href="{{url('/')}}"> <i class="dripicons-meter"></i><span>{{ __('file.dashboard') }}</span></a></li>
              ...
              <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-user-circle-o"></i><span>Users</span><span></a>
                <ul id="product" class="collapse list-unstyled ">
                  <li id="category-menu"><a href="{{route('viewUsers')}}">All Users</a></li>
                  <li id="category-menu"><a href="{{route('viewParent')}}">All Parents</a></li>
              ...
              <li><a href="#purchase" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-university"></i><span>Academic</span></a>
                <ul id="purchase" class="collapse list-unstyled ">
                  ...
                  <li id=""><a href="{{route('students.registration.view')}}">Student Registration</a></li>
                  
                  <li id=""><a href="{{route('setups.student.class.view')}}">Student Class</a></li>
                  <li id=""><a href="{{route('setups.student.year.view')}}">View Year</a></li>
                  <li id=""><a href="{{route('setups.student.group.view')}}">View Group</a></li>
                  <li id=""><a href="{{route('setups.student.shift.view')}}">Student Shift</a></li>
                  
                  <li id=""><a href="{{route('setups.subject.view')}}">Subject View</a></li>
                  <li id=""><a href="{{route('setups.assign.subject.view')}}">Assign Subject</a></li>
                  <li id=""><a href="{{route('setups.designation.view')}}">Designation</a></li>
                  <li id=""><a href="{{route('students.roll.view')}}">Roll Generate</a></li>
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-graduation-cap"></i><span>Exam</span></a>
                <ul id="sale" class="collapse list-unstyled ">
                  ...
                  <li id=""><a href="{{route('setups.exam.type.view')}}">Exam Type</a></li>
                  <li id=""><a href="{{route('marks.add')}}">Marks Entry</a></li>
                  <li id=""><a href="{{route('marks.edit')}}">Marks Edit</a></li>
                  <li id=""><a href="{{route('marks.grade.view')}}">Grade Point</a></li>
              ...
              <li><a href="#expense" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-line-chart"></i><span>Accounting</span></a>
                <ul id="expense" class="collapse list-unstyled ">
                  <li id=""><a href="{{route('setups.fee.category.view')}}">Fee Category</a></li>
                  <li id=""><a href="{{route('setups.fee.amount.view')}}">Fee Category Amount</a></li>
                  <li id=""><a href="{{route('accounts.fee.view')}}">Student Fee</a></li>
                  <!-- <li id="exp-list-menu"><a href="">Employee Salary</a></li> -->
                  
                  <li id=""><a href="{{route('students.exam.fee.view')}}">Exam Fee</a></li>
                  
                  <li id=""><a href="{{route('students.monthly.fee.view')}}">Monthly Fee</a></li>
                  ...
                  <li id="exp-list-menu"><a href="{{route('othercosts.index')}}">Account Other Cost</a></li>
              ...
              <li><a href="#quotation" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document"></i><span>Back Office</span><span></a>
                <ul id="quotation" class="collapse list-unstyled ">
                  ...
                  <li id="quotation-list-menu"><a href="{{route('holiday.index')}}">Holidays</a></li>
                  <li id="quotation-list-menu"><a href="{{route('contact')}}">Contact</a></li>
                  <li id="quotation-list-menu"><a href="{{route('leave.index')}}">Leave Purpose</a></li>
              ...
              <li><a href="#transfer" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-cog"></i><span>Settings</span></a>
                <ul id="transfer" class="collapse list-unstyled ">
                  <li> 
                        <a href="{{route('setting.general')}}">General Settings</a>
                  </li>
                  <li id="transfer-list-menu"><a href="{{route('role.index')}}">Role Permission</a></li>
        ...
        @if($department_active)
              <li><a href="#hrm" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document"></i><span>HRM</span><span></a>
                <ul id="hrm" class="collapse list-unstyled ">
                  ...
                  <li id="quotation-list-menu"><a href="{{route('departments.index')}}">Department</a></li>
                  <li id="quotation-list-menu"><a href="{{route('employees.index')}}">Employee </a></li>
                  <li id="quotation-list-menu"><a href="{{route('attendance.index')}}">Attendance</a></li>
                  <li id="quotation-list-menu"><a href="{{route('holiday.index')}}">Holiday</a></li>
            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                @if(\Auth::user()->role_id <= 2)
                  <li hidden="" class="nav-item"><a href="{{route('cashRegister.index')}}" title="{{trans('file.Cash Register List')}}"><i class="dripicons-archive"></i></a></li>
                @endif
